...
class Test_test_4_24(unittest.TestCase):
    def test_1(self):
        ast = loadJson("resources/0_4_24/test1.sol_json.ast")
    ...
    def test_2(self):
        ast = loadJson("resources/0_4_24/test2.sol_json.ast")
        add_opp = jsonSearch(ast, variable_search)
    ...
    def test_3(self):
        ast = loadJson("resources/0_4_24/test3.sol_json.ast")
        add_opp = jsonSearch(ast, variable_search)
    ...
    def test_4(self):
        ast = loadJson("resources/0_4_24/test4.sol_json.ast")
        add_opp = jsonSearch(ast, variable_search)
        expected = [[3, 'addr', 'address'], [9, 'map', 'mapping(uint256 => mapping(uint256 => bool))'], 
                    [15, 'a', 'uint8'], [19, 'b', 'uint256'], [23, 'c', 'uint16'], 
                    [27, 'i', 'uint256'], [33, 'g', 'bytes16'], [36, 'h', 'bytes8']]
        self.assertEqual(get_var_Type(add_opp), expected)

    def test_5_enum(self):
        ast = loadJson("resources/0_4_24/test5.sol_json.ast")
        add_opp = jsonSearch(ast, variable_search)
    ...
    def test_6_array(self):
        ast = loadJson("resources/0_4_24/test6.sol_json.ast")
        add_opp = jsonSearch(ast, variable_search)
    ...
    def test_7_contract(self):
        ast = loadJson("resources/0_4_24/test7.sol_json.ast")
        add_opp = jsonSearch(ast, variable_search)
        expected = [[3, 'owner', 'address'], [5, 'x', 'uint256'], [7, 'a', 'uint256'], 
    ...
    def test_8_var(self):
        ...
        add_opp = jsonSearch(ast, variable_search)
        expected = [[7, 'a', 'uint256'], [9, 'j', 'uint256'], [16, 'b', 'uint256'], 
